"""
Django settings for ecourt_backend project.
...
SECRET_KEY = 'django-insecure-%2-mqlikix4_ktzbv@%1u*f((i(kchvwxlpjp4f#^7$x)$)pv6'
...
INSTALLED_APPS = [
    ...
    'ecourts_api.apps.EcourtsApiConfig',
    'rest_framework',
    'corsheaders',
    'durin',
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"user_per_client": "5/min"},
...
REST_DURIN = {
        ...
        "USER_SERIALIZER": 'crs_api.serializers.UserSerializer',
